import { x as withLeadingSlash, q as joinURL, y as withoutTrailingSlash, W as withBase, A as hash } from '../nitro/nitro.mjs';
import { j as useRuntimeConfig } from './server.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-C8EdG0-L.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BbOmuYbh.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-8XzrEi7p.mjs.map
