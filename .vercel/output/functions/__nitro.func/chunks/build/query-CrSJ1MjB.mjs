...
import { u as useRequestEvent, a as useContentPreview } from './preview-BTYYGWsf.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-B8_Ek9st.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CrSJ1MjB.mjs.map
