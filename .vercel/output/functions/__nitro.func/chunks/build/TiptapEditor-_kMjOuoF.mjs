...
import CollaborationSidebar from './CollaborationSidebar-PgbLOXE-.mjs';
...
import '@iconify/vue';
import './CreatePullRequest-BJ5T8FuQ.mjs';
import '@octokit/rest';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(isLoggedIn)) {
        ...
        if (!previewMode.value && !rawMode.value) {
          ...
          _push(`<div class="preview-wrapper"><div>${(_a = previewContent.value) != null ? _a : ""}</div></div>`);
        }
        _push(`</div></div>`);
...
//# sourceMappingURL=TiptapEditor-_kMjOuoF.mjs.map
