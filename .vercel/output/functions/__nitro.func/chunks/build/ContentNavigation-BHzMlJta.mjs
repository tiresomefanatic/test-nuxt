...
import { u as useAsyncData } from './asyncData-DTkoFcJW.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-8XzrEi7p.mjs';
import { u as useContentPreview } from './preview-C8EdG0-L.mjs';
import { e as useState, j as useRuntimeConfig, a as __nuxt_component_0$1 } from './server.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
import 'node:path';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BbOmuYbh.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BHzMlJta.mjs.map
